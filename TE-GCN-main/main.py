...
def get_parser():
    ...
    parser.add_argument(
        '--work-dir',
        default='.work_dir/1024',
        help='the work folder for storing results')

    parser.add_argument('-model_saved_name', default='runs/1024')
    parser.add_argument(
        '--config',
        default='./config/uav-cross-subjectv1/train.yaml',
    ...
    parser.add_argument(
        '--batch-size', type=int, default=56, help='training batch size')
    parser.add_argument(
        '--test-batch-size', type=int, default=56, help='test batch size')
    parser.add_argument(
        '--start-epoch',
        type=int,
        default=0,
...
#            label = Variable(label.long(), requires_grad=False)
        ...
        if save_model:
            ...
            weights = OrderedDict([[k.split('module.')[-1],
                                    v.cuda(self.output_device)] for k, v in state_dict.items()])
